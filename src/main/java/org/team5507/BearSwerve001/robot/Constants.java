...
package org.team5507.BearSwerve001.robot;
...
public final class Constants {
    public static final class ROBOT {
        public static final double MASS_kg = Units.lbsToKilograms(40); // chassis only version of the robot
        ...
        static public final double ROBOT_MASS_kg = Units.lbsToKilograms(40);
    ...
    public static final class DRIVE {
         ...
         */
        public static final double TRACKWIDTH_METERS = 0.7; // FIXME Measure and set trackwidth
        /**
         * The front-to-back distance between the drivetrain wheels.
         *
         * Should be measured from center to center.
         */
        public static final double WHEELBASE_METERS = 0.7; // FIXME Measure and set wheelbase
        ...
        //public static final int PIGEON_ID = 0; //  NavX
